...
(function () {
  ...
  pointerEventProperties =
    "screenX screenY clientX clientY ctrlKey shiftKey altKey metaKey relatedTarget detail button buttons pointerId pointerType width height pressure tiltX tiltY isPrimary".split(
      " ",
    );
  ...
  if (!createUIEvent) {
    throw new Error(
      "Cannot create events. You may be using an unsupported browser.",
    );
  }
      ...
      if (unprefixed === "pointerover" || unprefixed === "pointerout") {
        window.addEventListener(
          ...
          function (originalEvent) {
            var unprefixedEvent = createEvent(
              unprefixed,
              originalEvent,
              originalEvent,
              false,
            ...
            if (!originalEvent.target.contains(originalEvent.relatedTarget)) {
              unprefixedEvent = createEvent(
                unprefixed === "pointerover" ? "pointerenter" : "pointerleave",
                originalEvent,
                originalEvent,
                true,
              );
  ...
  setUpMouseEvent = function (type) {
    if (type === "over" || type === "out") {
      window.addEventListener("mouse" + type, function (originalEvent) {
        ...
        if (!originalEvent.target.contains(originalEvent.relatedTarget)) {
          pointerEvent = createMouseProxyEvent(
            type === "over" ? "pointerenter" : "pointerleave",
            originalEvent,
            true,
          );
          originalEvent.target.dispatchEvent(pointerEvent);
  ...
  if (window.ontouchstart !== undefined) {
    ...
    createTouchProxyEvent = function (
      type,
      originalEvent,
      touch,
      noBubble,
    ...
    window.addEventListener("touchstart", function (event) {
      ...
      processTouch = function (touch) {
        ...
        pointerenterEvent = createTouchProxyEvent(
          "pointerenter",
          event,
          touch,
          true,
    ...
    window.addEventListener("touchmove", function (event) {
      ...
      processTouch = function (touch) {
        ...
        if (!previousTarget.contains(actualTarget)) {
          ...
          pointerleaveEvent = createTouchProxyEvent(
            "pointerleave",
            event,
            touch,
            true,
        ...
        // pointerout
        pointeroutEvent = createTouchProxyEvent(
          "pointerout",
          event,
          touch,
          false,
        ...
        // pointermove
        pointermoveEvent = createTouchProxyEvent(
          "pointermove",
          event,
          touch,
          false,
        ...
        // pointerover
        pointeroverEvent = createTouchProxyEvent(
          "pointerover",
          event,
          touch,
          false,
    ...
    window.addEventListener("touchend", function (event) {
      ...
      processTouch = function (touch) {
        ...
        pointerupEvent = createTouchProxyEvent(
          "pointerup",
          event,
          touch,
          false,
    ...
    window.addEventListener("touchcancel", function (event) {
      ...
      processTouch = function (touch) {
        ...
        pointercancelEvent = createTouchProxyEvent(
          "pointercancel",
          event,
          touch,
        );
