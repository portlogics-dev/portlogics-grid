...
export class ChevronCellTemplate implements CellTemplate<ChevronCell> {
  ...
  getCompatibleCell(
    uncertainCell: Uncertain<ChevronCell>,
  ...
  getClassName(cell: Compatible<ChevronCell>, _isInEditMode: boolean): string {
  ...
  getStyle(cell: Compatible<ChevronCell>, _isInEditMode: boolean): CellStyle {
